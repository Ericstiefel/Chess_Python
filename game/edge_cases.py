...
PROMOTION = [
    Move(Color.WHITE, PieceType.PAWN, Square.A2, Square.A4),
    Move(Color.BLACK, PieceType.PAWN, Square.H7, Square.H6),  
    Move(Color.WHITE, PieceType.PAWN, Square.A4, Square.A5),
    Move(Color.BLACK, PieceType.PAWN, Square.H6, Square.H5),  
    ...
    Move(Color.BLACK, PieceType.KNIGHT, Square.H6, Square.G8),
